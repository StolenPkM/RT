...
/*   Updated: 2018/04/24 17:38:12 by adhanot          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "rt.h"

void			ft_save_inter_cylinder(t_thread *thr, t_cylinder *cylinder, \
		t_camera *camera)
{
	t_vect		norm;
	double		dotc;
...
static double	ft_calc_inter_cylinder(t_cylinder *cylinder, t_vect pos, \
		t_vect vect)
{
	double		a;
	double		b;
