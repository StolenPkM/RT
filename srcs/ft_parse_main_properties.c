...
/*   Updated: 2018/04/24 18:08:57 by adhanot          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int						parse_filter(char *str)
{
	if (!(ft_strncmp(str, "none", 4)))
		...
		return (2);
	else if (!(ft_strncmp(str, "yellow", 6)))
		return (3);
	else if (!(ft_strncmp(str, "red", 3)))
		return (4);
	else if (!(ft_strncmp(str, "green", 5)))
		return (5);
	else if (!(ft_strncmp(str, "stereo", 6)))
		return (6);
	return (0);
}
